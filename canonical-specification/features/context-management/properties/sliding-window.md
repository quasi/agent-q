...
2. **LLM Token Limits**: 50 items ≈ 25K-50K tokens depending on item size, within typical 128K context windows
...
**Impact:** Adds O(n) latency to `add-context` when at capacity; < 1ms for default capacity (n=50)
