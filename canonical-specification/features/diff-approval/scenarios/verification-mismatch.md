...
**Gap:** No formal error recovery for verification mismatch. Recommended: compare SHA-256 of original content against file on disk before showing diff; reject with descriptive error if mismatch detected.
