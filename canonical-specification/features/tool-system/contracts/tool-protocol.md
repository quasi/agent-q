...
```json
{
  ...
  "description": "Schema for defining an executable tool",
  "properties": {
    "name": {
      "type": "string",
      "description": "Tool name in snake_case",
      "pattern": "^[a-z][a-z0-9_]*$",
      "examples": ["describe_symbol", "eval_form"]
    },
    "description": {
      "type": "string",
    ...
    "parameters": {
      ...
      "items": {
        ...
        "properties": {
          "name": {"type": "string"},
          "type": {"type": "string", "enum": ["string", "boolean", "number", "object", "array"]},
    ...
    "safety_level": {
      "type": "string",
      "enum": ["safe", "cautious", "dangerous"],
      "default": "safe",
      "description": "Safety level for approval requirements"
    },
    "categories": {
      "type": "array",
      "description": "Tool categories for organization",
      "items": {"type": "string"},
      "examples": [["introspection", "xref"]]
    }
  },
